...
\lstset{
    ...
    morekeywords={},
    emph={},
    emphstyle=\color{deepred}\sffamily\bfseries,
...
%1. %%%%%%%%%%% use below for override `verilog setting i.e. language = Verilog"
	%\section{`style' vs `language'}
	%\lstinputlisting[
	%caption    = {Add more color by changing ``mypreamble'' file},
	%language = Verilog,
	%label      = {sv:enum_typedef_example}
	%]{enum_typedef_example.sv}
	%
	
%2. %%%%%%%%%%%% use below for override `verilog setting i.e. style = Verilog"
	%\lstinputlisting[
	%caption    = {Add more color by changing ``mypreamble'' file},
	%style = Verilog,
	%label      = {sv:enum_typedef_example}
...
% language: SystemVerilog settings which override the `Verilog'
\lstdefinestyle{Verilog}{language=Verilog, 
	morekeywords={$stop, $readmemh, $readmemb, $time, always_comb, always_ff, always_latch, typedef, enum, logic},
	keywordstyle=\color{blue}\sffamily\bfseries,
}

% language: Python
\lstdefinestyle{Python}{language=Python, 
	morekeywords={__get__, __init__, __set__, numpy, pandas, matplotlib},
	emph={self},
	emphstyle=\color{deepred}\sffamily\bfseries,
	commentstyle=\itshape\color{red},
	keywordstyle=\color{blue}\sffamily\bfseries,
