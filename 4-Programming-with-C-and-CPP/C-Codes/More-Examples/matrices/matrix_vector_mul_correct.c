...
void matrix_vect_product(int [][N], int [][1], int [][1]);

// calculate matrix-vector product
void matrix_vect_product(int A[][N], int x[][1], int result[][1]){
...
int main(){
    ...
    // glablal variables are not passed... 
    matrix_vect_product(A, x, result);
